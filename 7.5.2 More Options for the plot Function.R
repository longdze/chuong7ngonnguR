#tạo ra một biểu đồ phân tán
lot(y = Benthic$Richness, x = Benthic$NAP, xlab = "Mean high tide (m)", ylab = "Species richness", main = "Benthic data ")
M0 <- lm(Richness ~ NAP, data = Benthic)
abline(M0) #thêm đường hồi quy vào biểu đồ phân tántán
#tạo bd phân tán
